...
function processScanResult(responseText, url) {
  ...
  try {
      ...
      // Create a more compact HTML result with minimal spacing
      const resultHtml = `<strong>URL:</strong> <a href="${link}" target="_blank">${link}</a><br><strong>Analysis:</strong> ${analysis}`;
